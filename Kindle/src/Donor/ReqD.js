...
function searchItems() {
  let currentList=filterItemsByCategory2(currentCategory);
...
function filterMedicalRequests() {
  ...
  const filteredRequests = FilterItems.filter((request) => {
    ...
    return medicalCategory === "all" || request.medicalCategory === medicalCategory;
